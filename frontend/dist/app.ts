...
/***/ "./src/components/card-element.ts":
/*!****************************************!*\
  !*** ./src/components/card-element.ts ***!
  \****************************************/
...
var CardElement = /** @class */ (function () {
    ...
    CardElement.cardElementForIncomeOrExpense = function (element) {
        var colCardElement = document.createElement("div");
    ...
    CardElement.createTable = function (operation) {
        var trElement = document.createElement('tr');
        var thNumberElement = document.createElement('th');
        ...
        var tdAmountElement = document.createElement('td');
        ...
        var tdCategoryElement = document.createElement('td');
...
var card_element_1 = __webpack_require__(/*! ./card-element */ "./src/components/card-element.ts");
var http_utils_1 = __webpack_require__(/*! ../utils/http-utils */ "./src/utils/http-utils.ts");
var localStorage_utils_1 = __webpack_require__(/*! ../utils/localStorage-utils */ "./src/utils/localStorage-utils.ts");
var Costs = /** @class */ (function () {
    function Costs(openNewRoute) {
        this.url = '/categories/expense';
        this.pageTitle = "Расходы";
        this.cardAddElement = null;
        this.alertPopupElement = null;
        this.buttonYesAlertPopupElement = null;
        this.buttonNoAlertPopupElement = null;
    ...
    Costs.prototype.showCategoriesExpense = function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.getCategoriesExpense()];
                    case 1:
                        _a.expenses = _b.sent();
                        if (this.expenses && this.expenses.length > 0) {
                            this.expenses.forEach(function (element) {
                                ...
                                var card = card_element_1.CardElement.cardElementForIncomeOrExpense(element.title);
                                var cardTitle = card.querySelector('.card-text');
                                if (cardTitle) {
                                    cardTitle.innerHTML = element.title;
                                }
                                var buttonDelete = card.querySelector('.delete-button');
                                if (buttonDelete) {
                                    buttonDelete.addEventListener('click', function (event) {
                                        _this.showAlertPopup(element);
                                    });
                                }
                                var buttonEdit = card.querySelector('.edit-button');
                                if (buttonEdit) {
                                    buttonEdit.addEventListener('click', function (event) {
                                        _this.editExpense(element);
                                    });
                                }
                                colElement.appendChild(card);
                                _this.cardsElement.appendChild(colElement);
                            });
                        }
                        this.addCreateCard();
                        return [2 /*return*/];
    ...
    Costs.prototype.addCreateCard = function () {
        var _this = this;
        ...
        if (cardAdd) {
            cardAdd.addEventListener('click', function () {
                _this.goCreateCategoryExpense();
            });
        }
    };
    Costs.prototype.getCategoriesExpense = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, http_utils_1.HttpUtils.request(this.url)];
                    case 1:
                        result = _a.sent();
    ...
    Costs.prototype.showAlertPopup = function (element) {
        var _this = this;
        ...
        var yesHandler = function () {
            _this.alertPopupElement.style.display = 'none';
            if (_this.currentDeleteElement) {
                _this.deleteCategoryExpense(_this.currentDeleteElement);
            }
        };
        var noHandler = function () {
            _this.alertPopupElement.style.display = 'none';
            _this.currentDeleteElement = null;
        };
        this.buttonYesAlertPopupElement.onclick = yesHandler;
        this.buttonNoAlertPopupElement.onclick = noHandler;
    };
    Costs.prototype.deleteCategoryExpense = function (element) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, http_utils_1.HttpUtils.request((this.url + '/' + element.id), 'DELETE')];
                    case 1:
                        result = _a.sent();
                        if (!result.error) {
    ...
    Costs.prototype.editExpense = function (element) {
        return __awaiter(this, void 0, void 0, function () {
            var existingCategory, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 7]);
                        return [4 /*yield*/, localStorage_utils_1.LocalStorageUtils.getCategory()];
                    case 1:
                        existingCategory = _a.sent();
                        if (!existingCategory) return [3 /*break*/, 3];
                        return [4 /*yield*/, localStorage_utils_1.LocalStorageUtils.removeCategory()];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [4 /*yield*/, localStorage_utils_1.LocalStorageUtils.setCategory(element)];
                    case 4:
                        _a.sent();
                        this.openNewRoute("/categories?type=edit&category=expense&id=".concat(element.id));
                        return [3 /*break*/, 7];
                    case 5:
                        error_1 = _a.sent();
                        console.error('Error accessing localStorage:', error_1);
                        return [4 /*yield*/, localStorage_utils_1.LocalStorageUtils.setCategory(element)];
                    case 6:
                        _a.sent();
                        this.openNewRoute("/categories?type=edit&category=expense&id=".concat(element.id));
                        return [3 /*break*/, 7];
    ...
    Costs.prototype.goCreateCategoryExpense = function () {
...
/***/ "./src/components/create-category.ts":
/*!*******************************************!*\
  !*** ./src/components/create-category.ts ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var CreateCategory = /** @class */ (function () {
    function CreateCategory(openNewRoute) {
        this.apiUrl = '';
    ...
    CreateCategory.prototype.initPage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var pageTitle, category, type, id;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log('Params:', { category: category, type: type, id: id });
                        if (!category || !type) {
                        ...
                        if (!(type === 'edit')) return [3 /*break*/, 4];
                        pageTitle.innerText = 'Редактирование категории';
                        if (!id) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.loadCategoryData(id)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2: throw new Error('ID категории не указан для редактирования');
    ...
    CreateCategory.prototype.loadCategoryData = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var result, categoryData, categoryInput, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, http_utils_1.HttpUtils.request("".concat(this.apiUrl, "/").concat(id), 'GET')];
                    case 1:
                        result = _a.sent();
                        if (result.error || !result.response) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.error('Error loading category:', error_1);
    ...
    CreateCategory.prototype.handleSubmit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var type;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.validateInput()) return [3 /*break*/, 4];
                        type = this.urlParams.get('type');
                        if (!(type === 'create')) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.createCategory()];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2:
                        if (!(type === 'edit')) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.editCategory()];
                    case 3:
                        _a.sent();
                        _a.label = 4;
    ...
    CreateCategory.prototype.validateInput = function () {
        var categoryInput = this.categoryInput;
        if (!categoryInput) {
            return false;
        }
    ...
    CreateCategory.prototype.createCategory = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sendButton, categoryInput, result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, http_utils_1.HttpUtils.request(this.apiUrl, 'POST', true, {
    ...
    CreateCategory.prototype.editCategory = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sendButton, categoryInput, result, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sendButton = this.sendButton;
                    ...
                    case 1:
                        _a.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, http_utils_1.HttpUtils.request("".concat(this.apiUrl, "/").concat(this.currentCategoryId), 'PUT', true, {
                                title: categoryInput.value.trim()
                            })];
                    case 2:
                        result = _a.sent();
    ...
    CreateCategory.prototype.showError = function (message) {
        var errorElement = document.getElementById("input-name-category-error");
        if (errorElement) {
    ...
    CreateCategory.prototype.redirectBack = function () {
        var category = this.urlParams.get('category');
        if (category === 'income') {
    ...
    CreateCategory.prototype.cancel = function () {
        this.redirectBack();
    };
...
/***/ "./src/components/create-transaction.ts":
/*!**********************************************!*\
  !*** ./src/components/create-transaction.ts ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var http_utils_1 = __webpack_require__(/*! ../utils/http-utils */ "./src/utils/http-utils.ts");
var layout_1 = __webpack_require__(/*! ./layout */ "./src/components/layout.ts");
var CreateTransaction = /** @class */ (function () {
    function CreateTransaction(openNewRoute) {
        var _this = this;
        this.urlCreate = '/operations';
        this.urlIncome = '/categories/income';
        this.urlExpense = '/categories/expense';
        this.pageTitle = "Создание дохода/расхода";
        ...
        var typeSelectElement = this.typeSelectElement;
        var buttonCreateElement = this.buttonCreateElement;
        if (pageTitleElement) {
        ...
        if (this.typeOperation === 'expense') {
            if (this.selectExpenseElement)
                this.selectExpenseElement.selected = true;
            if (this.selectIncomeElement)
    ...
    CreateTransaction.prototype.showCategory = function () {
        return __awaiter(this, void 0, void 0, function () {
            var categorySelectElement, _a, noCategoryOption;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        categorySelectElement = this.categorySelectElement;
                    ...
                    case 1:
                        ...
                        if (this.categoryList && this.categoryList.length > 0) {
                            ...
                            noCategoryOption = document.createElement('option');
    ...
    CreateTransaction.prototype.updateCategories = function () {
        return __awaiter(this, void 0, void 0, function () {
            var typeSelectElement;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        typeSelectElement = this.typeSelectElement;
                        if (typeSelectElement) {
                            this.typeOperation = typeSelectElement.value;
                        }
                        return [4 /*yield*/, this.showCategory()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    CreateTransaction.prototype.validateForm = function () {
        var typeSelectElement = this.typeSelectElement;
        var categorySelectElement = this.categorySelectElement;
        var amountInputElement = this.amountInputElement;
        var dateInputElement = this.dateInputElement;
        var commentInputElement = this.commentInputElement;
        var isValid = true;
        ...
        if (commentInputElement && commentInputElement.value.trim()) {
            ...
            if (commentInputElement)
                commentInputElement.classList.add('is-invalid');
            isValid = false;
        }
        return isValid;
    };
    CreateTransaction.prototype.setIncomeExpense = function () {
        return __awaiter(this, void 0, void 0, function () {
            var typeSelectElement, categorySelectElement, amountInputElement, dateInputElement, commentInputElement, buttonCreateElement, requestData, result, errorMessage, inputErrorElement, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        typeSelectElement = this.typeSelectElement;
                        categorySelectElement = this.categorySelectElement;
                        amountInputElement = this.amountInputElement;
                        dateInputElement = this.dateInputElement;
                        commentInputElement = this.commentInputElement;
                        buttonCreateElement = this.buttonCreateElement;
                        if (!typeSelectElement || !categorySelectElement || !amountInputElement ||
                            !dateInputElement || !commentInputElement || !buttonCreateElement) {
                            return [2 /*return*/];
                        }
                        if (!this.validateForm()) return [3 /*break*/, 10];
                        requestData = {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, http_utils_1.HttpUtils.request(this.urlCreate, 'POST', true, requestData)];
                    case 2:
                        result = _a.sent();
                        ...
                        inputErrorElement = document.getElementById("input-name-category-error");
                    ...
                    case 3:
                        ...
                        if (!(typeof layout_1.Layout !== 'undefined' && layout_1.Layout.setBalance)) return [3 /*break*/, 5];
                        return [4 /*yield*/, layout_1.Layout.setBalance()];
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5:
    ...
    CreateTransaction.prototype.getCategory = function () {
        return __awaiter(this, void 0, void 0, function () {
            var url, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
var Dashboard = /** @class */ (function () {
    function Dashboard(openNewRoute) {
        this.url = '/operations';
        this.balanceUrl = '/balance';
        this.chartIncome = null;
        this.chartExpenses = null;
        this.canvasIncomeElement = null;
        this.canvasExpensesElement = null;
        this.canvasIncome = null;
        this.canvasExpenses = null;
        this.startDate = null;
        this.endDate = null;
        this.colors = [
        ...
        this.openNewRoute = openNewRoute;
        var canvasIncomeElement = document.getElementById('canvas-inc');
        var canvasExpensesElement = document.getElementById('canvas-exp');
    ...
    Dashboard.prototype.initEventListeners = function () {
        var _this = this;
        var todayBtn = document.getElementById('button-today');
        var weekBtn = document.getElementById('button-week');
        var monthBtn = document.getElementById('button-month');
        var yearBtn = document.getElementById('button-year');
        var allBtn = document.getElementById('button-all');
        var intervalBtn = document.getElementById('button-interval');
        var startDateLink = document.getElementById('startDateLink');
        var endDateLink = document.getElementById('endDateLink');
        var detailsBtn = document.getElementById('button-details');
        var bindPeriodButton = function (btn, period) {
            if (!btn)
                return;
            btn.addEventListener('click', function () {
                _this.setActiveButton(btn);
                _this.getOperations(period);
            });
        };
        ...
        if (intervalBtn) {
            intervalBtn.addEventListener('click', function () {
                _this.setActiveButton(intervalBtn);
                _this.selectDateRange();
            });
        }
        if (startDateLink) {
            startDateLink.addEventListener('click', function (e) {
                e.preventDefault();
                _this.selectStartDate();
            });
        }
        if (endDateLink) {
        ...
        if (detailsBtn) {
            detailsBtn.addEventListener('click', function () {
                _this.openNewRoute('/costs');
            });
        }
        this.setActiveButton(allBtn);
    };
    Dashboard.prototype.updateBalance = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result, balanceElement, error_1;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, http_utils_1.HttpUtils.request(this.balanceUrl)];
                    case 1:
                        result = _b.sent();
                        if (result.error)
                            return [2 /*return*/];
                        if (((_a = result.response) === null || _a === void 0 ? void 0 : _a.balance) !== undefined) {
                            balanceElement = document.getElementById('balance-amount');
                            if (balanceElement) {
                                balanceElement.textContent = "".concat(result.response.balance, "$");
                            }
                        }
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _b.sent();
                        console.error('Balance update error:', error_1);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
    ...
    Dashboard.prototype.setActiveButton = function (activeButton) {
    ...
    Dashboard.prototype.selectDateRange = function () {
        var startDate = prompt("Выберите дату начала (YYYY-MM-DD):");
        if (!startDate)
            return;
        var endDate = prompt("Выберите дату окончания (YYYY-MM-DD):");
        if (!endDate)
            return;
        var startDateLink = document.getElementById('startDateLink');
        var endDateLink = document.getElementById('endDateLink');
        if (startDateLink)
            startDateLink.textContent = startDate;
        if (endDateLink)
            endDateLink.textContent = endDate;
        this.startDate = startDate;
        this.endDate = endDate;
        this.getOperations('interval', startDate, endDate);
    };
    Dashboard.prototype.selectStartDate = function () {
        var selectedDate = prompt("Выберите дату начала (YYYY-MM-DD):");
        if (selectedDate) {
            var link = document.getElementById('startDateLink');
            if (link)
                link.textContent = selectedDate;
            this.startDate = selectedDate;
        }
    };
    Dashboard.prototype.selectEndDate = function () {
        var selectedDate = prompt("Выберите дату окончания (YYYY-MM-DD):");
        if (selectedDate) {
            var link = document.getElementById('endDateLink');
            if (link)
                link.textContent = selectedDate;
            this.endDate = selectedDate;
        }
    };
    Dashboard.prototype.isValidDate = function (dateString) {
    ...
    Dashboard.prototype.createData = function (operations) {
        if (!operations || operations.length === 0) {
            this.showEmptyCharts();
            return;
        }
        var expenses = operations.filter(function (item) { return item.type === 'expense'; });
        var incomes = operations.filter(function (item) { return item.type === 'income'; });
        var aggregatedExpenses = this.aggregateByCategory(expenses);
        var aggregatedIncomes = this.aggregateByCategory(incomes);
        this.updateCharts(aggregatedIncomes, aggregatedExpenses);
    };
    Dashboard.prototype.showEmptyCharts = function () {
        this.destroyCharts();
        var emptyData = {
            labels: ['Нет данных'],
            datasets: [{
        ...
        var emptyConfig = this.getConfig(emptyData, 'Нет данных');
        emptyConfig.options.plugins.tooltip = {
            callbacks: {
                label: function () { return 'Нет данных для отображения'; }
            }
        };
        if (this.isCanvasAvailable(this.canvasIncomeElement))
            this.chartIncome = new chart_js_1.Chart(this.canvasIncome, emptyConfig);
        if (this.isCanvasAvailable(this.canvasExpensesElement))
            this.chartExpenses = new chart_js_1.Chart(this.canvasExpenses, emptyConfig);
    };
    Dashboard.prototype.isCanvasAvailable = function (canvasElement) {
        if (!canvasElement)
            return false;
        var existingChart = chart_js_1.Chart.getChart(canvasElement);
        if (existingChart)
    ...
    Dashboard.prototype.destroyCharts = function () {
        var _a, _b;
        [this.canvasIncomeElement, this.canvasExpensesElement].forEach(function (el) {
            if (el) {
                var chart = chart_js_1.Chart.getChart(el);
                if (chart)
                    chart.destroy();
            }
        });
        (_a = this.chartIncome) === null || _a === void 0 ? void 0 : _a.destroy();
        (_b = this.chartExpenses) === null || _b === void 0 ? void 0 : _b.destroy();
        this.chartIncome = null;
        this.chartExpenses = null;
    };
    Dashboard.prototype.aggregateByCategory = function (items) {
        return items.reduce(function (acc, cur) {
            var category = cur.category;
            var amount = cur.amount;
            if (!acc[category])
                acc[category] = { category: category, total: 0 };
            acc[category].total += amount;
            return acc;
        }, {});
    };
    Dashboard.prototype.updateCharts = function (incomes, expenses) {
        this.destroyCharts();
        var incomeLabels = Object.keys(incomes);
        var expenseLabels = Object.keys(expenses);
        var incomeData = {
            labels: incomeLabels,
            datasets: [{
                    data: Object.values(incomes).map(function (i) { return i.total; }),
        ...
        var expenseData = {
            ...
            datasets: [{
                    data: Object.values(expenses).map(function (i) { return i.total; }),
        ...
        if (incomeLabels.length && this.isCanvasAvailable(this.canvasIncomeElement))
            this.chartIncome = new chart_js_1.Chart(this.canvasIncome, this.getConfig(incomeData, 'Доходы'));
        ...
        if (expenseLabels.length && this.isCanvasAvailable(this.canvasExpensesElement))
            this.chartExpenses = new chart_js_1.Chart(this.canvasExpenses, this.getConfig(expenseData, 'Расходы'));
        else if (this.isCanvasAvailable(this.canvasExpensesElement))
            this.showEmptyChart(this.canvasExpenses, 'Расходы');
    };
    Dashboard.prototype.showEmptyChart = function (ctx, title) {
        var emptyData = {
            labels: ['Нет данных'],
            datasets: [{ data: [1], backgroundColor: ['#e9ecef'] }]
        };
        var config = this.getConfig(emptyData, title);
        config.options.plugins.tooltip = {
            callbacks: {
                label: function () { return "\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u043F\u043E ".concat(title.toLowerCase()); }
            }
        };
        return new chart_js_1.Chart(ctx, config);
    };
    Dashboard.prototype.getOperations = function () {
        return __awaiter(this, arguments, void 0, function (period, dateFrom, dateTo) {
            var queryParams, queryString, url, result;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url = queryString ? "".concat(this.url, "?").concat(queryString) : this.url;
                        return [4 /*yield*/, http_utils_1.HttpUtils.request(url)];
                    case 1:
                        result = _a.sent();
                        if (result.error) {
    ...
    Dashboard.prototype.getConfig = function (data, title) {
    ...
    Dashboard.updateDiag = function () {
        return __awaiter(this, arguments, void 0, function (period, dateFrom, dateTo) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dashboardInstance = new Dashboard(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/];
                        }); }); });
                        return [4 /*yield*/, dashboardInstance.getOperations(period, dateFrom, dateTo)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
/***/ "./src/components/edit-transactions.ts":
/*!*********************************************!*\
  !*** ./src/components/edit-transactions.ts ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.EditTransactions = void 0;
var localStorage_utils_1 = __webpack_require__(/*! ../utils/localStorage-utils */ "./src/utils/localStorage-utils.ts");
var http_utils_1 = __webpack_require__(/*! ../utils/http-utils */ "./src/utils/http-utils.ts");
var EditTransactions = /** @class */ (function () {
    function EditTransactions(openNewRoute) {
        this.urlEdit = '/operations';
        this.urlIncome = '/categories/income';
        this.urlExpense = '/categories/expense';
        this.pageTitle = "Редактирование дохода/расхода";
    ...
    EditTransactions.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, pageTitleElement, typeSelectElement, buttonCreateElement, selectCategoryTitle, error_1;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        _a = this;
                        return [4 /*yield*/, localStorage_utils_1.LocalStorageUtils.getOperation()];
                    case 1:
                        _a.editOperation = _b.sent();
                        console.log(this.editOperation);
                        if (!this.editOperation) {
                            console.error('No operation data found in localStorage');
                            return [2 /*return*/];
                        }
                        pageTitleElement = this.pageTitleElement;
                        typeSelectElement = this.typeSelectElement;
                        buttonCreateElement = this.buttonCreateElement;
                        selectCategoryTitle = this.selectCategoryTitle;
                        if (pageTitleElement) {
                            pageTitleElement.innerText = this.pageTitle;
                        }
                        ...
                        if (typeSelectElement) {
                            typeSelectElement.addEventListener('change', function (event) {
                                var target = event.target;
                                _this.typeOperation = target.value;
                                _this.getCategory().then();
                            });
                        }
                        if (buttonCreateElement) {
                        ...
                        if (typeSelectElement) {
                            typeSelectElement.addEventListener('change', function (e) {
                                ...
                                if (_this.typeOperation === 'income') {
                                    if (_this.selectExpenseElement)
                                        _this.selectExpenseElement.removeAttribute('selected');
                                    if (_this.selectIncomeElement)
                                        _this.selectIncomeElement.setAttribute('selected', 'selected');
                                }
                                else {
                                    if (_this.selectIncomeElement)
                                        _this.selectIncomeElement.removeAttribute('selected');
                                    if (_this.selectExpenseElement)
                                        _this.selectExpenseElement.setAttribute('selected', 'selected');
                                }
                            });
                        }
                        return [4 /*yield*/, this.getCategory()];
                    ...
                    case 3:
                        error_1 = _b.sent();
                        console.error('Error initializing EditTransactions:', error_1);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
    ...
    EditTransactions.prototype.showCategory = function (categories) {
        var _this = this;
        var categorySelectElement = this.categorySelectElement;
        var amountInputElement = this.amountInputElement;
        var dateInputElement = this.dateInputElement;
        ...
        if (categories && categories.length > 0) {
            categories.forEach(function (category) {
                var optionElement = document.createElement('option');
                if (category.title === _this.editOperation.category) {
    ...
    EditTransactions.prototype.editIncomeExpense = function () {
        return __awaiter(this, void 0, void 0, function () {
            var typeSelectElement, categorySelectElement, amountInputElement, dateInputElement, commentInputElement, requestData, result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        typeSelectElement = this.typeSelectElement;
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, http_utils_1.HttpUtils.request(this.urlEdit + '/' + this.editOperation.id, 'PUT', true, requestData)];
                    case 2:
                        result = _a.sent();
                        if (result && !result.error) {
                            localStorage_utils_1.LocalStorageUtils.removeOperation(); // Очищаем localStorage после успешного редактирования
                            this.openNewRoute('/transactions');
                        }
                        else {
                            alert('Ошибка при сохранении операции: ' + result.message);
                        }
                        return [3 /*break*/, 4];
                    case 3:
                        error_2 = _a.sent();
                        console.error('Error editing transaction:', error_2);
    ...
    EditTransactions.prototype.validateForm = function () {
        var categorySelectElement = this.categorySelectElement;
        var amountInputElement = this.amountInputElement;
        var dateInputElement = this.dateInputElement;
        var commentInputElement = this.commentInputElement;
    ...
    EditTransactions.prototype.getCategory = function () {
        return __awaiter(this, void 0, void 0, function () {
            var url, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
var Layout = /** @class */ (function () {
    ...
    Layout.prototype.updateUserInfo = function () {
        var userInfo = auth_utils_1.AuthUtils.getAuthInfo(auth_utils_1.AuthUtils.userInfoTokenKey);
        var userNameElement = document.querySelector('.user-name');
        if (userInfo && userNameElement) {
            try {
                var userInfoString = typeof userInfo === 'string' ? userInfo : JSON.stringify(userInfo);
                var userData = JSON.parse(userInfoString);
                if (userData.name && userData.lastName) {
                    userNameElement.textContent = "".concat(userData.name, " ").concat(userData.lastName);
                }
            }
            catch (e) {
    ...
    Layout.prototype.updateBalance = function () {
        return __awaiter(this, void 0, void 0, function () {
            var authToken, headers, result, data, balanceElement, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        authToken = auth_utils_1.AuthUtils.getAuthInfo(auth_utils_1.AuthUtils.accessTokenKey);
                        headers = {
                        ...
                        return [4 /*yield*/, fetch('http://localhost:3000/api/balance', {
                                method: 'GET',
                                headers: headers
                            })];
                    case 1:
    ...
    Layout.prototype.setupHoverEffects = function () {
        var _this = this;
        var navItems = document.querySelectorAll('.nav-item:not(.active)');
        navItems.forEach(function (navItem) {
            navItem.addEventListener('mouseenter', function () {
                _this.updateNavItemIcons(navItem, true);
            });
            navItem.addEventListener('mouseleave', function () {
                _this.updateNavItemIcons(navItem, false);
            });
        });
    };
    Layout.prototype.setupUserDropdown = function () {
        var _this = this;
    ...
    Layout.prototype.openUserMenu = function () {
        var userDropdownMenu = document.getElementById('userDropdownMenu');
        if (userDropdownMenu) {
    ...
    Layout.prototype.closeUserMenu = function () {
        var userDropdownMenu = document.getElementById('userDropdownMenu');
        if (userDropdownMenu) {
    ...
    Layout.prototype.setupActiveState = function () {
        var _this = this;
        this.updateActiveNavItem(window.location.pathname);
        document.addEventListener('routeChanged', function (e) {
            var customEvent = e;
            _this.updateActiveNavItem(customEvent.detail.route);
        });
    };
    Layout.prototype.updateActiveNavItem = function (activeRoute) {
        var _this = this;
        document.querySelectorAll('.nav-item').forEach(function (item) {
            item.classList.remove('active');
            _this.updateNavItemIcons(item, false);
        });
        var activeLink = this.findActiveNavLink(activeRoute);
        if (activeLink) {
            activeLink.classList.add('active');
            this.updateNavItemIcons(activeLink, true);
            activeLink.removeEventListener('mouseenter', function () { });
            activeLink.removeEventListener('mouseleave', function () { });
            this.openCategoriesForRelatedPages(activeRoute, activeLink);
        }
        this.setupHoverEffects();
    };
    Layout.prototype.findActiveNavLink = function (activeRoute) {
        var activeLink = document.querySelector("a[href=\"".concat(activeRoute, "\"]"));
        if (activeLink)
            return activeLink;
        var routeMappings = {
        ...
        for (var _i = 0, _a = Object.entries(routeMappings); _i < _a.length; _i++) {
            var _b = _a[_i], route = _b[0], targetRoute = _b[1];
            if (activeRoute === route || activeRoute.startsWith(route)) {
                activeLink = document.querySelector("a[href=\"".concat(targetRoute, "\"]"));
                if (activeLink)
                    return activeLink;
            }
        }
    ...
    Layout.prototype.resolveCategoriesRoute = function () {
    ...
    Layout.prototype.openCategoriesForRelatedPages = function (activeRoute, activeLink) {
        var dropdownCheckbox = document.getElementById('categories-toggle');
        if (!dropdownCheckbox)
            return;
        var categoryRelatedPages = [
            '/profit', '/costs',
            '/profit/create-profit', '/profit/edit-profit',
            '/categories'
        ];
        var isCategoryPage = categoryRelatedPages.includes(activeRoute) ||
    ...
    Layout.prototype.updateNavItemIcons = function (navItem, showActive) {
        var navItemIcon = navItem.querySelector('.nav-item-icon');
        if (navItemIcon) {
            var normalIcon = navItemIcon.querySelector('.normal-icon');
            var activeIcon = navItemIcon.querySelector('.active-icon');
    ...
    Layout.prototype.setupDropdownBehavior = function () {
        document.addEventListener('click', function (e) {
            var dropdown = document.querySelector('.dropdown');
            var checkbox = document.getElementById('categories-toggle');
            ...
            var shouldKeepOpen = keepOpenPages.includes(window.location.pathname) ||
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        layout = new Layout();
                        return [4 /*yield*/, layout.updateBalance()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
var Login = /** @class */ (function () {
    ...
    Login.prototype.validateForm = function () {
        var emailElement = this.emailElement;
        ...
        if (emailElement && emailElement.value && this.isValidEmail(emailElement.value)) {
            ...
            emailElement === null || emailElement === void 0 ? void 0 : emailElement.classList.add('is-invalid');
            isValid = false;
        }
        if (passwordElement && passwordElement.value && passwordElement.value.length >= 6) {
            ...
            passwordElement === null || passwordElement === void 0 ? void 0 : passwordElement.classList.add('is-invalid');
            isValid = false;
        }
        return isValid;
    };
    Login.prototype.isValidEmail = function (email) {
        var emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
        return emailRegex.test(email);
    };
    Login.prototype.login = function () {
        return __awaiter(this, void 0, void 0, function () {
            var emailElement, passwordElement, rememberMeElement, commonErrorElement, processButton, requestData, result, loginResponse, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        emailElement = this.emailElement;
                        passwordElement = this.passwordElement;
                        rememberMeElement = this.rememberMeElement;
                        commonErrorElement = this.commonErrorElement;
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, http_utils_1.HttpUtils.request('/login', 'POST', false, requestData)];
                    case 2:
                        result = _a.sent();
                        ...
                        auth_utils_1.AuthUtils.setAuthInfo(loginResponse.tokens.accessToken, loginResponse.tokens.refreshToken, {
    ...
    Login.prototype.isValidLoginResponse = function (response) {
        return (response &&
            response.tokens &&
...
var Logout = /** @class */ (function () {
    function Logout(openNewRoute) {
        this.openNewRoute = openNewRoute;
        var accessToken = auth_utils_1.AuthUtils.getAuthInfo(auth_utils_1.AuthUtils.accessTokenKey);
        var refreshToken = auth_utils_1.AuthUtils.getAuthInfo(auth_utils_1.AuthUtils.refreshTokenKey);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(refreshToken && typeof refreshToken === 'string')) return [3 /*break*/, 2];
                        return [4 /*yield*/, http_utils_1.HttpUtils.request('/logout', 'POST', false, {
...
var card_element_1 = __webpack_require__(/*! ./card-element */ "./src/components/card-element.ts");
var localStorage_utils_1 = __webpack_require__(/*! ../utils/localStorage-utils */ "./src/utils/localStorage-utils.ts");
var Profit = /** @class */ (function () {
    function Profit(openNewRoute) {
        this.url = '/categories/income';
        this.pageTitle = "Доходы";
        this.cardAddElement = null;
        this.alertPopupElement = null;
        this.buttonYesAlertPopupElement = null;
        this.buttonNoAlertPopupElement = null;
    ...
    Profit.prototype.showCategoriesIncome = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, cardsElement;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, this.getCategoriesIncome()];
                    case 1:
                        _a.incomes = _b.sent();
                        cardsElement = this.cardsElement;
    ...
    Profit.prototype.addCreateCard = function () {
        var _this = this;
        if (this.cardAddElement && this.cardsElement) {
            this.cardAddElement.innerHTML = '<div class="card d-flex justify-content-center align-items-center p-0">'
                + '<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">'
            ...
            if (cardAdd) {
                cardAdd.addEventListener('click', function () {
                    _this.goCreateCategoryIncome();
                });
            }
        }
    };
    Profit.prototype.getCategoriesIncome = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Profit.prototype.showAlertPopup = function (element) {
        var _this = this;
        if (!this.alertPopupElement || !this.buttonYesAlertPopupElement || !this.buttonNoAlertPopupElement) {
            return;
        }
        ...
        var yesHandler = function () {
            var _a, _b;
            if (_this.alertPopupElement) {
                _this.alertPopupElement.style.display = 'none';
            }
            if (_this.currentDeleteElement) {
                _this.deleteCategoryIncome(_this.currentDeleteElement);
            }
            (_a = _this.buttonYesAlertPopupElement) === null || _a === void 0 ? void 0 : _a.removeEventListener('click', yesHandler);
            (_b = _this.buttonNoAlertPopupElement) === null || _b === void 0 ? void 0 : _b.removeEventListener('click', noHandler);
        };
        var noHandler = function () {
            var _a, _b;
            if (_this.alertPopupElement) {
    ...
    Profit.prototype.deleteCategoryIncome = function (element) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Profit.prototype.editIncome = function (element) {
        return __awaiter(this, void 0, void 0, function () {
            var existingCategory, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        this.openNewRoute("/categories?type=edit&category=income&id=".concat(element.id));
                        return [3 /*break*/, 7];
                    case 5:
                        error_1 = _a.sent();
                        console.error('Error accessing localStorage:', error_1);
    ...
    Profit.prototype.goCreateCategoryIncome = function () {
...
var Register = /** @class */ (function () {
    function Register(openNewRoute) {
    ...
    Register.prototype.validateForm = function () {
        ...
        var lastNameElement = this.lastNameElement;
        var emailElement = this.emailElement;
        var passwordElement = this.passwordElement;
        var passwordRepeatElement = this.passwordRepeatElement;
        var isValid = true;
        if (nameElement && nameElement.value.trim()) {
            nameElement.classList.remove('is-invalid');
        }
        else {
            nameElement === null || nameElement === void 0 ? void 0 : nameElement.classList.add('is-invalid');
            isValid = false;
        }
        if (lastNameElement && lastNameElement.value.trim()) {
            ...
            lastNameElement === null || lastNameElement === void 0 ? void 0 : lastNameElement.classList.add('is-invalid');
            isValid = false;
        }
        if (emailElement && emailElement.value && this.isValidEmail(emailElement.value)) {
            emailElement.classList.remove('is-invalid');
        ...
        if (passwordRepeatElement && passwordElement &&
            ...
            passwordRepeatElement === null || passwordRepeatElement === void 0 ? void 0 : passwordRepeatElement.classList.add('is-invalid');
            isValid = false;
        }
        return isValid;
    };
    ...
    Register.prototype.isValidPassword = function (password) {
        var passwordRegex = /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])[0-9a-zA-Z]{8,}$/;
        return passwordRegex.test(password);
    };
    Register.prototype.signUp = function () {
        return __awaiter(this, void 0, void 0, function () {
            var nameElement, lastNameElement, emailElement, passwordElement, passwordRepeatElement, commonErrorElement, processButton, requestData, result, validationErrors, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        nameElement = this.nameElement;
                        lastNameElement = this.lastNameElement;
                        emailElement = this.emailElement;
                        passwordElement = this.passwordElement;
                        passwordRepeatElement = this.passwordRepeatElement;
                        commonErrorElement = this.commonErrorElement;
                        processButton = this.processButton;
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, http_utils_1.HttpUtils.request('/signup', 'POST', false, requestData)];
                    case 2:
                        result = _a.sent();
                        if (result.response && result.response.validation) {
                            validationErrors = result.response.validation;
                            validationErrors === null || validationErrors === void 0 ? void 0 : validationErrors.forEach(function (error) {
                                console.log("Validation error: ".concat(error.field, " - ").concat(error.message));
                            });
                        }
    ...
    Register.prototype.isValidRegisterResponse = function (response) {
...
/***/ "./src/components/transactions.ts":
/*!****************************************!*\
  !*** ./src/components/transactions.ts ***!
  \****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var Transactions = /** @class */ (function () {
    function Transactions(openNewRoute) {
        var _this = this;
        ...
        (_a = this.buttonCreateIncome) === null || _a === void 0 ? void 0 : _a.addEventListener('click', function () {
            sessionStorage.setItem('type', 'income');
        });
        (_b = this.buttonCreateExpense) === null || _b === void 0 ? void 0 : _b.addEventListener('click', function () {
            sessionStorage.setItem('type', 'expense');
        });
        this.buttonsBlockElement.forEach(function (button) {
            button.addEventListener('click', function () {
                _this.buttonsBlockElement.forEach(function (btn) { return btn.classList.remove('active'); });
                button.classList.add('active');
            });
        });
        (_c = this.buttonTodayElement) === null || _c === void 0 ? void 0 : _c.addEventListener('click', function () {
            _this.setActiveButton(_this.buttonTodayElement);
            _this.getOperations('today').then();
        });
        (_d = this.buttonWeekElement) === null || _d === void 0 ? void 0 : _d.addEventListener('click', function () {
            _this.setActiveButton(_this.buttonWeekElement);
            _this.getOperations('week').then();
        });
        (_e = this.buttonMonthElement) === null || _e === void 0 ? void 0 : _e.addEventListener('click', function () {
            _this.setActiveButton(_this.buttonMonthElement);
            _this.getOperations('month').then();
        });
        (_f = this.buttonYearElement) === null || _f === void 0 ? void 0 : _f.addEventListener('click', function () {
            _this.setActiveButton(_this.buttonYearElement);
            _this.getOperations('year').then();
        });
        (_g = this.buttonAllElement) === null || _g === void 0 ? void 0 : _g.addEventListener('click', function () {
            _this.setActiveButton(_this.buttonAllElement);
            _this.getOperations('all').then();
        });
        (_h = this.buttonIntervalElement) === null || _h === void 0 ? void 0 : _h.addEventListener('click', function () {
            _this.setActiveButton(_this.buttonIntervalElement);
            _this.selectDateRange();
        });
        this.setActiveButton(this.buttonAllElement);
        this.getOperations('all').then();
    }
    Transactions.prototype.setActiveButton = function (activeButton) {
        var buttons = document.querySelectorAll('.btn-outline-secondary');
    ...
    Transactions.prototype.selectDateRange = function () {
        var startDate = prompt("Выберите дату начала (YYYY-MM-DD):");
        if (!startDate) {
            return;
        }
        ...
        var startDateLink = document.getElementById('link-interval-start');
        var endDateLink = document.getElementById('link-interval-end');
        if (startDateLink)
            startDateLink.textContent = startDate;
        if (endDateLink)
            endDateLink.textContent = endDate;
    ...
    Transactions.prototype.isValidDate = function (dateString) {
        var regex = /^\d{4}-\d{2}-\d{2}$/;
        if (!regex.test(dateString))
            return false;
        var date = new Date(dateString);
    ...
    Transactions.prototype.showIncomeExpense = function (operations) {
        var _this = this;
        if (operations === void 0) { operations = null; }
        var tableTbodyElement = this.tableTbodyElement;
        ...
        if (operations && operations.length > 0) {
            operations.forEach(function (operation) {
                var row = card_element_1.CardElement.createTable(operation);
                var trashIcon = row.querySelector('.trash');
                if (trashIcon) {
                    trashIcon.addEventListener('click', function (event) {
                        event.stopPropagation();
                        _this.showAlertPopup(operation);
                    });
                }
                var pencilIcon = row.querySelector('.pencil');
                if (pencilIcon) {
                    pencilIcon.addEventListener('click', function (event) {
                        event.stopPropagation();
                        _this.editOperation(operation);
                    });
                }
    ...
    Transactions.prototype.editOperation = function (operation) {
        return __awaiter(this, void 0, void 0, function () {
            var existingOperation, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 7]);
                        return [4 /*yield*/, localStorage_utils_1.LocalStorageUtils.getOperation()];
                    case 1:
                        existingOperation = _a.sent();
                        if (!existingOperation) return [3 /*break*/, 3];
                        return [4 /*yield*/, localStorage_utils_1.LocalStorageUtils.removeOperation()];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [4 /*yield*/, localStorage_utils_1.LocalStorageUtils.setOperation(operation)];
                    case 4:
                        _a.sent();
                    ...
                    case 5:
                        error_1 = _a.sent();
                        console.error('Error accessing localStorage:', error_1);
                        return [4 /*yield*/, localStorage_utils_1.LocalStorageUtils.setOperation(operation)];
                    case 6:
                        _a.sent();
                        this.openNewRoute('/edit-transaction');
                        return [3 /*break*/, 7];
    ...
    Transactions.prototype.deleteOperation = function (operation) {
        return __awaiter(this, void 0, void 0, function () {
            var result, tableTbodyElement;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, http_utils_1.HttpUtils.request(this.url + '/' + operation.id, 'DELETE')];
                    case 1:
                        result = _a.sent();
                        if (result.error) {
                        ...
                        tableTbodyElement = this.tableTbodyElement;
                        if (tableTbodyElement) {
                            tableTbodyElement.innerHTML = '';
                        }
                        return [4 /*yield*/, this.getOperations('all')];
                    case 2:
                        _a.sent();
                        if (!(typeof layout_1.Layout !== 'undefined' && layout_1.Layout.setBalance)) return [3 /*break*/, 4];
                        return [4 /*yield*/, layout_1.Layout.setBalance()];
                    case 3:
                        _a.sent();
                        _a.label = 4;
    ...
    Transactions.prototype.showAlertPopup = function (operation) {
        var _this = this;
        ...
        var yesHandler = function () {
            ...
            if (operation) {
                _this.deleteOperation(operation);
            }
            (_a = _this.buttonYesElement) === null || _a === void 0 ? void 0 : _a.removeEventListener('click', yesHandler);
            (_b = _this.buttonNoElement) === null || _b === void 0 ? void 0 : _b.removeEventListener('click', noHandler);
        };
        var noHandler = function () {
            var _a, _b;
            if (_this.alertPopupElement) {
    ...
    Transactions.prototype.getOperations = function () {
        return __awaiter(this, arguments, void 0, function (period, dateFrom, dateTo) {
            var queryParams, queryString, url, result;
            if (period === void 0) { period = 'all'; }
            if (dateFrom === void 0) { dateFrom = null; }
...
var Router = /** @class */ (function () {
        ...
        this.routes = [
                ...
                load: function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                new layout_1.Layout();
                                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./components/dashboard */ "./src/components/dashboard.ts")); })];
                            case 1:
                                Dashboard = (_a.sent()).Dashboard;
                ...
                load: function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                new layout_1.Layout();
                                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./components/costs */ "./src/components/costs.ts")); })];
                            case 1:
                                Costs = (_a.sent()).Costs;
                ...
                load: function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                new layout_1.Layout();
                                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./components/profit */ "./src/components/profit.ts")); })];
                            case 1:
            ...
            },
            {
                ...
                load: function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./components/transactions */ "./src/components/transactions.ts")); })];
                            case 1:
                ...
                load: function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                new layout_1.Layout();
                                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./components/create-transaction */ "./src/components/create-transaction.ts")); })];
                            case 1:
                                CreateTransaction = (_a.sent()).CreateTransaction;
                ...
                load: function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                new layout_1.Layout();
                                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./components/edit-transactions */ "./src/components/edit-transactions.ts")); })];
                            case 1:
                                EditTransactions = (_a.sent()).EditTransactions;
                ...
                load: function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                new layout_1.Layout();
                                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./components/create-category */ "./src/components/create-category.ts")); })];
                            case 1:
                                CreateCategory = (_a.sent()).CreateCategory;
            ...
            },
            {
                ...
                load: function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./components/login */ "./src/components/login.ts")); })];
                            case 1:
                                Login = (_a.sent()).Login;
            ...
            },
            {
                ...
                load: function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./components/register */ "./src/components/register.ts")); })];
                            case 1:
            ...
            },
            {
                ...
                load: function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./components/logout */ "./src/components/logout.ts")); })];
                            case 1:
    ...
    Router.prototype.initEvents = function () {
        var _this = this;
        window.addEventListener('DOMContentLoaded', function () { return _this.activateRoute(); });
        window.addEventListener('popstate', function () { return _this.activateRoute(); });
    ...
    Router.prototype.clickHandler = function (e) {
        ...
        else if (((_a = target.parentNode) === null || _a === void 0 ? void 0 : _a.nodeName) === 'A') {
            element = target.parentNode;
        }
        if (element) {
            e.preventDefault();
            var url = element.href.replace(window.location.origin, '');
    ...
    Router.prototype.resolveRouteAlias = function (route) {
        return this.routeAliases[route] || route;
    };
    Router.prototype.activateRoute = function (oldRoute) {
        return __awaiter(this, void 0, void 0, function () {
            var currentRoute_1, urlRoute, resolvedRoute, currentRoute, contentBlock, _a, templateContent, error_1, error_2;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (oldRoute) {
                            currentRoute_1 = this.routes.find(function (item) { return item.route === oldRoute; });
                            if (currentRoute_1 && currentRoute_1.unload && typeof currentRoute_1.unload === 'function') {
                                currentRoute_1.unload();
                            }
                        }
                        urlRoute = window.location.pathname;
                        resolvedRoute = this.resolveRouteAlias(urlRoute);
                        if (resolvedRoute !== urlRoute) {
                            history.replaceState({}, '', resolvedRoute);
                            urlRoute = resolvedRoute;
                        }
                        if (urlRoute.startsWith('/categories')) {
                            currentRoute = this.routes.find(function (item) { return item.route === '/categories'; });
                        }
                        else {
                            currentRoute = this.routes.find(function (item) { return item.route === urlRoute; });
                        }
                        if (!currentRoute) return [3 /*break*/, 12];
                        ...
                        if (!(currentRoute.filePathTemplate && this.contentPageElement)) return [3 /*break*/, 7];
                        contentBlock = this.contentPageElement;
                        if (!currentRoute.useLayout) return [3 /*break*/, 2];
                        _a = this.contentPageElement;
                        return [4 /*yield*/, fetch(currentRoute.useLayout).then(function (response) { return response.text(); })];
                    case 1:
                    ...
                    case 2:
                        ...
                        _b.label = 3;
                    case 3:
                        if (!contentBlock) return [3 /*break*/, 7];
                        _b.label = 4;
                    case 4:
                        _b.trys.push([4, 6, , 7]);
                        return [4 /*yield*/, fetch(currentRoute.filePathTemplate).then(function (response) { return response.text(); })];
                    case 5:
                    ...
                    case 6:
                        error_1 = _b.sent();
                        console.error('Error loading template:', currentRoute.filePathTemplate, error_1);
                        contentBlock.innerHTML = '<div class="alert alert-danger">Ошибка загрузки страницы</div>';
                        return [3 /*break*/, 7];
                    case 7:
                        if (!(currentRoute.load && typeof currentRoute.load === 'function')) return [3 /*break*/, 11];
                        _b.label = 8;
                    case 8:
                        _b.trys.push([8, 10, , 11]);
                        return [4 /*yield*/, currentRoute.load()];
                    case 9:
                        _b.sent();
                        return [3 /*break*/, 11];
                    case 10:
                        error_2 = _b.sent();
                        console.error('Error in route load function:', error_2);
                        return [3 /*break*/, 11];
                    case 11:
                    ...
                    case 12:
                        ...
                        return [4 /*yield*/, this.activateRoute()];
                    case 13:
                        _b.sent();
                        _b.label = 14;
    ...
    Router.prototype.initLayout = function () {
        return __awaiter(this, void 0, void 0, function () {
            var Layout_1, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(__webpack_require__(/*! ./components/layout */ "./src/components/layout.ts")); })];
                    case 1:
                        Layout_1 = (_a.sent()).Layout;
                        this.layout = new Layout_1();
                        return [3 /*break*/, 3];
                    case 2:
                        error_3 = _a.sent();
                        console.error('Failed to load Layout:', error_3);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
    ...
    Router.prototype.isAuthenticated = function () {
        var accessToken = localStorage.getItem('accessToken');
        return !!accessToken;
    };
    Router.prototype.updateActiveNavItem = function (activeRoute) {
        ...
        var routeToActivate = activeRoute;
        ...
        var activeLink = document.querySelector("a[href=\"".concat(routeToActivate, "\"]"));
...
var config_1 = __webpack_require__(/*! ./config */ "./src/utils/config.ts");
var AuthUtils = /** @class */ (function () {
    ...
    AuthUtils.updateRefreshToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result, refreshToken, response, resultData, existingUserInfo, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        result = false;
                    ...
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, fetch(config_1.config.api + "/refresh", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                    "Accept": "application/json",
                    ...
                    case 3:
                        ...
                        if (resultData && !resultData.error) {
                            existingUserInfo = this.getUserInfo();
                            this.setAuthInfo(resultData.tokens.accessToken, resultData.tokens.refreshToken, existingUserInfo || { id: '', name: '', lastName: '' });
                            result = true;
                        }
                        _a.label = 4;
                    case 4: return [3 /*break*/, 6];
                    case 5:
                        error_1 = _a.sent();
                        console.error("Token refresh error:", error_1);
                        return [3 /*break*/, 6];
                    case 6:
                        if (!result) {
                            this.removeAuthInfo();
    ...
    AuthUtils.getUserInfo = function () {
        var userInfoStr = localStorage.getItem(this.userInfoTokenKey);
        if (userInfoStr) {
            try {
    ...
    AuthUtils.userInfoTokenKey = "userInfoToken";
    return AuthUtils;
}());
...
var HttpUtils = /** @class */ (function () {
    ...
    HttpUtils.request = function (url_1) {
        return __awaiter(this, arguments, void 0, function (url, method, useAuth, body) {
            var result, accessToken, refreshToken, params, response, _a, e_1, updateTokenResult;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        accessToken = auth_utils_1.AuthUtils.getAuthInfo(auth_utils_1.AuthUtils.accessTokenKey);
                        refreshToken = auth_utils_1.AuthUtils.getAuthInfo(auth_utils_1.AuthUtils.refreshTokenKey);
                        params = {
                            method: method,
                            headers: {
                    ...
                    case 1:
                        _b.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, fetch(config_1.config.api + url, params)];
                    case 2:
                        response = _b.sent();
                        _a = result;
                        return [4 /*yield*/, response.json()];
...
var LocalStorageUtils = /** @class */ (function () {
    ...
    LocalStorageUtils.setCategory = function (value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    LocalStorageUtils.getCategory = function () {
        return __awaiter(this, void 0, void 0, function () {
            var item;
            return __generator(this, function (_a) {
                item = localStorage.getItem(this.CategoryKey);
                return [2 /*return*/, item ? JSON.parse(item) : null];
            });
        });
    };
    LocalStorageUtils.removeCategory = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    LocalStorageUtils.setOperation = function (value) {
        localStorage.setItem(this.OperationKey, JSON.stringify(value));
    };
    LocalStorageUtils.getOperation = function () {
        var item = localStorage.getItem(this.OperationKey);
        return item ? JSON.parse(item) : null;
    };
    LocalStorageUtils.removeOperation = function () {
        localStorage.removeItem(this.OperationKey);
    };
    LocalStorageUtils.CategoryKey = 'category';
    LocalStorageUtils.OperationKey = 'operation';
...
var App = /** @class */ (function () {
    ...
    App.prototype.setupDropdown = function () {
    ...
    App.prototype.setupActiveStates = function () {
        var navItems = document.querySelectorAll('.nav-item:not(.sub-item)');
        navItems.forEach(function (item) {
            item.addEventListener('click', function () {
                if (!item.classList.contains('dropdown-header')) {
                    navItems.forEach(function (navItem) { return navItem.classList.remove('active'); });
                    item.classList.add('active');
                }
            });
        });
    };
    App.prototype.setupMobileMenu = function () {
        var _this = this;
        ...
        window.addEventListener('resize', function () { return _this.addMobileMenuButton(); });
    ...
    App.prototype.addMobileMenuButton = function () {
        if (window.innerWidth <= 768) {
...
window.updateBalance = function (amount) {
    ...
    if (balanceElement) {
        balanceElement.textContent = "".concat(amount, "$");
    }
};
new App();

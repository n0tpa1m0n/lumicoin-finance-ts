import { OperationForTable } from "../types/operation.types";

export class CardElement {
    static cardElementForIncomeOrExpense(element: string): HTMLElement {
    ...
    static createTable(operation: OperationForTable): HTMLTableRowElement {
